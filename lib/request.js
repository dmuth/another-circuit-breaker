...
*
*/
exports.handleRequest = function(req, res, stats, url, clever, cb_in) {
	...
	if (clever) {
		handleRequestClever(req, res, stats, url, cb);

	} else {
		handleRequestNaive(req, res, stats, url, cb);
...
*/
function handleRequestClever(req, res, stats, url, cb) {
...
*/
function handleRequestNaive(req, res, stats, url, cb) {
